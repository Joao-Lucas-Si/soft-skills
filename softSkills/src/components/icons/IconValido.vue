...
<template>
<svg  v-if="estado == undefined" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" xmlns:serif="http://www.serif.com/" fill="#000000" width="800px" height="800px" viewBox="0 0 60 60" version="1.1" xml:space="preserve" style="fill-rule:evenodd;clip-rule:evenodd;stroke-linejoin:round;stroke-miterlimit:2;">
...
<svg v-else-if="estado"  xmlns="http://www.w3.org/2000/svg" width="800px" height="800px" viewBox="0 0 28 28" fill="#000">
    <path xmlns="http://www.w3.org/2000/svg" d="M5 16.577l2.194-2.195 5.486 5.484L24.804 7.743 27 9.937l-14.32 14.32z"/>
</svg>
<svg v-else xmlns="http://www.w3.org/2000/svg" width="800px" height="800px" viewBox="0 0 24 24" stroke="#000" fill="none">
    <path d="M12 10V13" stroke-width="2" stroke-linecap="round"/>
    <path d="M12 16V15.9888" stroke-width="2" stroke-linecap="round"/>
    <path d="M10.2518 5.147L3.6508 17.0287C2.91021 18.3618 3.87415 20 5.39912 20H18.6011C20.126 20 21.09 18.3618 20.3494 17.0287L13.7484 5.147C12.9864 3.77538 11.0138 3.77538 10.2518 5.147Z"  stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
</svg>
